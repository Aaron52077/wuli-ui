        ...
        const component = new Component({
            ...
            methods: {
                ...
                onClose(e, callback) {
                    ...
                    this.setData({
                        [`$filterbar.items[${index}].visible`]: false,
                    }, () => {
                ...
                onRadioChange(e) {
                    ...
                    this.setData({
                        [`$filterbar.items[${parentIndex}].children[${index}].children`]: children,
                        [`$filterbar.items[${parentIndex}].children[${index}].selected`]: selected,
                    })
                },
                /**
