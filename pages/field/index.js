...
Page(Object.assign({}, Wuli.Field, {
  ...
  handleWuliFieldFocus(e) {
    ...
    console.log('[wuli:field:focus]', componentId, detail);
  },

  handleWuliFieldBlur(e) {
    const { componentId, detail } = e;

    console.log('[wuli:field:blur]', componentId, detail);
  },
  ...
  formReset(event) {
    console.log('[wuli:field:reset]', event);
  },
